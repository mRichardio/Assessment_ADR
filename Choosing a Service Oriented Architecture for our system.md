...
* Bad, because it will be hard to keep data consistant, as sharing data around the different components will be hard to manage along with managing inter service communication could cause latency issues.
